          ...
          <div class="order-foot-wrap">
            <div class="prev-btn-wrap">
             <!-- <button class="btn btn&#45;&#45;m">修改订单</button>-->
              <router-link to="/address">修改订单</router-link>
            </div>
            <div class="next-btn-wrap">
              <button class="btn btn--m btn--red"
                      @click="payMent">提交订单</button>
  ...
  import axios from "axios"
    ...
    export default {
      ...
      methods:{
        ...
        /*提交支付 路由跳转 单支付一般都是由第三方接口 这里仅为模拟*/
        payMent () {
          //地址 id 跳转的参数 在Address.vue 路由跳转 传递的参数
