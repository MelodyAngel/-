<template>
  <!--只有一个header标签 而没有同级标签 所以可以不用在外面创建div-->
    <header class="header">

      <svg class="goods-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" display="none">
        <defs>
...
<!--style如果不使用 请删除 不然页面会生成无效的 style 空标签-->
<!--<style scoped>
